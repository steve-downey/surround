...
The overdone project infrastructure in the top-level project is to support GitHub CI and various bits of code quality. The CI is mostly driven by shell scripts in the .ci directory, which are borrowed from the [[git@github.com:emacs-exordium/exordium.git][Exordium Project]] and were written by [[https://github.com/pkryger][Przemysław Kryger]] who despaired of us breaking our shared emacs configuration. The [[https://github.com/pre-commit/pre-commit][pre-commit framework]] infrastructure is my fault, but helps me keep YAML less broken, and reduced the number of spelling mistakes and formatting errors. Running it automatically keeps me honest.
...
This project also has overdone infrastructure, largely borrowed from the [[https://github.com/bemanproject][Beman Project]], reusing the infra from [[git@github.com:bemanproject/infra.git][bemanproject/infra]] and [[git@github.com:bemanproject/exemplar.git][bemanproject/exemplar]].
